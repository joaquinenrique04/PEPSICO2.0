  ...
  <header>
          ...
          <!-- desplega --> 
                  ...
                  <ul class="list">
                      <li class="list_item">
                          <div class="list_button">
                              ...
                              <a href="Nosotros.php" class="nav_link">Inicio</a>
                          </div>
                      </li>
                      <li class="list_item">
                          <div class="list_button" id="iniciar-sesion">
                              ...
                              <a href="iniciodes.php" class="nav_link">Iniciar sesión</a>
                          </div>
                      </li>
                      <li class="list_item">
                          <div class="list_button">
                              ...
                              <a href="registro.php" class="nav_link">Regístrate</a>
                          </div>
                      </li>
                      <li class="list_item">
                          <div class="list_button">
            ...
            <div style="margin: right 20px;flex-shrink:0" class=" md:w-48">
              <img style=" margin-right: 40px;height:3rem;" class="md:h-10" src="../images/PepsiCo_logo.png" alt="">
            </div>
            ...
            <nav style="margin-left: 70px;display:contents" class="">
              <ul style="margin-left:1rem;justify-content:flex-end;display:flex;align-items:center" class=" xl:w-48 ">
                ...
                <li style="margin-left:1rem;display:inline-block;font-weight: bold;position:relative" class="  ">
                  <a class="" href="">
                    <div style="--tw-bg-opacity: 1;background-color: rgb(74 99 159);position:absolute;padding-left:0.25rem;padding-right:0.25rem;padding-top:0px;padding-bottom:0px;font-weight:700;color: aliceblue;font-size:0.75rem;line-height:1rem;border-radius:0.125rem;right:0px;z-index:10;top:-0.25rem" class="  ">0</div>
                ...
                <li style="margin-left:1rem;display:inline-block;font-weight: bold;position:relative" class="">
                  <a class="" href="carrito.php">
                    <div style="--tw-bg-opacity: 1;background-color: rgb(74 99 159);position:absolute;padding-left:0.25rem;padding-right:0.25rem;font-weight:700;color: aliceblue;font-size:0.75rem;line-height:1rem;border-radius:0.125rem;right:0px;z-index:10;top:-0.25rem" class="  ">0</div>
...
<section id="nuestra-empresa" class="about">
  <img src="../images/pantryshop_hero_spring.avif">

  <div class="about_text">
      <h1>SOBRE NOSOTROS</h1>
      <p>PepsiCo en el MundoPepsiCo es la segunda compañía más importante del mundo en la industria de alimentos y bebidas. Como Empresa contamos con más de 100 marcas líderes en más de 200 países alrededor del mundo. La empresa emplea a más de 285.000 personas unidas por el compromiso único de crecimiento sostenido, invirtiendo en un futuro más saludable para las personas y nuestro planeta, que llamamos Desempeño con Propósito.</p>
  </div>
</section>
...
<section id="mision-vision" class="mision-vision">
  <section class="mission">
      <div class="mission_text">
          <h1>Misión</h1>
              <h3>Crear más sonrisas con cada sorbo y cada bocado</h3>
              <p><strong>Para nuestros consumidores:</strong> Creando momentos de alegría a través de nuestros deliciosos y nutritivos productos y experiencias de marca únicas.<br>
              <strong>Para nuestros clientes:</strong> Al ser el mejor socio posible, impulsar la innovación revolucionaria y ofrecer un nivel de crecimiento inigualable en nuestra industria.<br>
              <strong>Por nuestro planeta:</strong> Conservando los preciosos recursos de la naturaleza y fomentando un planeta más sostenible para nuestros hijos y nietos.<br></p>            </div>
  </section>
  <section class="vision">
      <div class="vision_text">
          <h1>Visión</h1>
          <h3>Ganar con PepsiCo Positivo</h3>
          <p>Guiando a PepsiCo está nuestra visión que captura el espíritu competitivo, el intenso enfoque y los valores compartidos de PepsiCo: ser el líder mundial en bebidas y alimentos convenientes ganando con PepsiCo Positive (Pep+). <br>
          Pep+ es nuestra transformación estratégica de extremo a extremo que coloca la sostenibilidad y el capital humano en el centro de cómo crearemos valor y crecimiento operando dentro de los límites planetarios e inspirando cambios positivos para el planeta y las personas. 
          </p>
      </div>
  </section>
</section>

<section id="nuestra-historia" class="timeline">
  <div class="title">
  ...
  <div class="checkpoint">
      <div>
          <h2>1974</h2>
          <p>PepsiCo establece una planta de producción en Lima, Perú.</p>
      </div>
  </div>
  <div class="checkpoint">
      <div>
          <h2>1988</h2>
          <p>PepsiCo expande la presencia de Sabritas, una marca de Frito-Lay, en el mercado peruano, fortaleciendo así su posición en el mercado de aperitivos en Perú.</p>
      </div>
  </div>
  <div class="checkpoint">
      <div>
          <h2>1994</h2>
          <p>PepsiCo adquiere Gatorade, ampliando su cartera de productos en Perú hacia las bebidas deportivas.</p>
      </div>
  </div>
  <div class="checkpoint">
      <div>
          <h2>2001</h2>
          <p>PepsiCo adquiere Quaker Oats Company, fortaleciendo su presencia en el mercado de alimentos y bebidas en Perú.</p>
      </div>
  </div>
  <div class="checkpoint">
      <div>
          <h2>2009</h2>
          <p>PepsiCo lanza su programa "Reciclar Perú", destinado a fomentar la cultura del reciclaje en el país.</p>
      </div>
  </div>
  <div class="checkpoint">
      <div>
          <h2>2011</h2>
          <p>PepsiCo Perú lanza "Sembrando Futuro", un programa de agricultura sostenible destinado a mejorar la productividad de los agricultores peruanos.</p>
      </div>
  </div>
  <div class="checkpoint">
      <div>
          <h2>2020</h2>
          <p>PepsiCo Perú anuncia iniciativas para promover la alimentación saludable y reducir el impacto ambiental de sus operaciones en el país.</p>
      </div>
  </div>
</section>
