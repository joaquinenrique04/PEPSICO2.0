          ...
          <!-- desplega --> 
            ...
            <nav style="display:contents">
              <ul style="justify-content:flex-end;display:flex;align-items:center" class="xl:w-48">
                ...
                <li style="margin-left:1rem;display:inline-block;position:relative">
                  <a class="nav-link" href="ofertas.php" style="font-weight: normal; color: #23438f; text-decoration: none;"
                     onmouseover="this.style.fontWeight='bold'; this.style.color='#23438f';"
                     onmouseout="this.style.fontWeight='normal'; this.style.color='#23438f';">
                     Ofertas especiales
                  </a>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="box">
          <a  href="">
            ...
            <button id="miBoton" style="font-family: 'Archivo Black', sans-serif;" class="boton-comprar button-22" role="button" onclick="toggleComprar()"><strong>COMPRAR</strong></button>
            </button>
            <div class="newr">
              <span id="descuento"><strong>-10%</strong>
              </span>
            </div>
            <div class="newrc">
