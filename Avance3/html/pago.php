...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/stylesmediopago.css">
</head>
                    ...
                    <div class='window'>
                        <div class='order-info'>
                            <div class='order-info-content'>
                                ...
                                <table class='order-table'>
                                    <tbody>
                                        <tr>
                                            <td><img style='width:100%; margin-bottom: -70px;'
                                                    src='../images/pepsi2.png'></img>
                                            </td>
                                            <td>
                                                <br> <span class='thin'>Pepsi</span>
                                                <br> <span class='thin small'>Lts:
                                                    3L</span>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class='total'>
                                    ...
                                    <span style='float:right; text-align:right;'>
                                        ...
                                        <div class='thin dense'>S/. 5.00</div>
                                        S/. 17.00
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class='credit-info'>
                            <div class='credit-info-content'>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class='dropdown' id='card-dropdown'>
                                                ...
                                                <select id='current-card'>
    
                                                    <option>Tarjeta Debito o Credito</option>
                                                    <option>Yape o Plim</option>
                                ...
                                <div id='yape-plim-info' style='display: none;'>
                                    
                                    <div style='text-align: center;'>
                                        <div style='max-width: 1000px; margin: 0 auto;'>
                                            <img height=200 src='../images/codigoyape.png' />
                                            <!-- Ajusta el ancho de la imagen según sea necesario -->
                                        </div>
                                        <a style="display: block; margin-top: 30px;">Subir Comprobante:</a>
                                        <input id="imageInput" type="file" accept="image/*" style="margin-top: 10px;">
                                        <button onclick="validateAndSubmitImage()"
                                            style="margin-top: 1px;">Enviar</button>
                                    </div>
    
                                </div>
                                <div id='credit-card-info' style="display: none;">
                                    <div center; display: flex; justify-content: flex-end; align-items: center; height:
                                        100%;>
                                        <img width="292" height='1000' src='../images/tarjeta.png' class='credit-card-image'
                                            id='credit-card-image'></img>
                                    </div>
                                    <h3>Numero Tarjeta</h3>
                                    <input class='input-field card-number'></input>
                                    Titular Tarjeta
                                    <input class='input-field card-holder-name'></input>
                                    <table class='half-input-table'>
                                        <tr>
                                            <td> Expira
                                                <input class='input-field expiry-date'></input>
                                            </td>
                                            <td>CVC
                                                <input class='input-field cvc'></input>
                                            </td>
                                        </tr>
                                    </table>
