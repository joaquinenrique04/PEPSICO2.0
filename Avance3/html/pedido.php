...
<head>
    ...
    <title>Producto - Pepsico </title>
    <script type="text/javascript" src="../js/despliegue.js"></script>
    <link rel="stylesheet" type="text/css" href="../css/stylespedido.css">
</head>
    ...
    <section>
        <nav class="nav-lat" id="nav-lat">
            <ul class="list">
                ...
                <li class="list_item">
                    <div class="list_button" id="iniciar-sesion">
                        <svg class="nav-icon" style="height: 1.75rem;padding:0.15rem;fill: #23438f;" class=" lg:h-10  "
                ...
                <li class="list_item">
                    <div class="list_button">
                        ...
                        <a href="" class="nav_link">Alimentos y snacks</a>
                    </div>
                </li>
                <li class="list_item">
                    <div class="list_button">
                        ...
                        <a href="" class="nav_link">Bebidas</a>
                    </div>
                </li>
            </ul>
        </nav>
    </section>
    <section style="display: block" class="shop_section layout_padding">
        <div class="container">
            <div class="grid">
                <img src="../images/gatored.png" alt="Product 1" class="rounded-lg shadow-lg">
                <img src="../images/chese.png" alt="Product 2" class="rounded-lg shadow-lg">
                <img src="../images/dorito.png" alt="Product 3" class="rounded-lg shadow-lg">
                <img src="../images/sevena.png" alt="Product 4" class="rounded-lg shadow-lg">
                <img src="../images/pepsi2.png" alt="Product 5" class="rounded-lg shadow-lg">
                <img src="../images/lays.png" alt="Product 6" class="rounded-lg shadow-lg">
            </div>
            <div class="contenedor">

                    <h1>PREPARA TU PEDIDO EN 15 MINUTOS</h1>
                    <h2>¡Descubre el Sabor PepsiCo en Línea!
                        Desde bebidas refrescantes hasta deliciosas snacks , nuestra 
                        amplia gama de productos está a solo unos clics de distancia.
                        Entra ahora a nuestro sitio web y descubre un mundo de sabores
                        que satisfacerán todos tus antojos.
                        
                        ¿Por qué elegirnos?
                        Contamos con una variedad en productos incomparable
                        Desde el clásico sabor de Pepsi hasta las últimas innovaciones
                        bebidas y snack, tenemos algo para cada gusto y ocasión.
                         
                        Sobre todo la Comonidad en Línea: Con solo unos pocos clics,
                        podrás tener tus productos favoritos desde la puerta de tu
                        casa, navega , seleeciona y disfruta .
                        ¡ASÍ DE FÁCIL!
                    </h2>
                    <h2>Mantengamos en contacto!</h2>
                    <br>
                    <center>
                        <div class="flex items-center justify-center mb-4">
                            <input
                              ...
                              class="p-2 rounded-l-lg border border-zinc-300 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-blue-500 w-64 h-12"
                            />
          ...
          margin-left: 0px;margin-bottom: 0px;padding-bottom: 0%;height: 112px;">
            ...
            <div class="caja">
                ...
                <section class="links-section">
                    ...
                    <a href="#mision-vision">Misión y visión</a><br>
