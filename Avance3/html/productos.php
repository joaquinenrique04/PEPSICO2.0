  ...
  <header>
          ...
          <!-- desplega --> 
            ...
            <div style="margin: right 20px;flex-shrink:0" class=" md:w-48">
              <img style=" margin-right: 40px;height:3rem;" class="md:h-10" src="PepsiCo_logo.svg.png" alt="">
            </div>
...
<section style="display: block" class="shop_section layout_padding">
  <div class="lineone">
    <div class="oline">
      <div class="centerp1" onclick="window.location.href = 'bebidas.php';" >
      <h2 style="font-family: 'Archivo Black', sans-serif;font-size: 30px;">
        BEBIDAS
      </h2>
     </div> 
    </div>
    ...
    <div class="oline">
      <div class=" centerp2" onclick="window.location.href = 'productos.php';">
      <h2 style="font-family: 'Archivo Black', sans-serif;font-size: 30px; ">
        PRODUCTOS
      </h2>
     </div> 
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="box">
          <a  href="">
            ...
            <div style="font-family: 'Poppins', sans-serif;font-size: 23px;" class="detail-box">
              <h6>
                DORITOS queso 45g
              </h6>
              <h6>
            ...
            <button style="font-family: 'Archivo Black', sans-serif;" class="button-22" role="button"><strong>COMPRAR</strong></button>
            <div class="newr">
                <span><strong>-10%</strong>
                </span>
              </div>
            <div class="newrc">
              <span><strong>12U</strong>
              </span>
            </div>
          </a>
        </div>
